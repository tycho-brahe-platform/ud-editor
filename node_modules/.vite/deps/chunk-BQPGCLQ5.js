import {
  ...
  removeClass,
  require_jsx_runtime
} from "./chunk-K3IN5PXP.js";
import {
  require_react_dom
} from "./chunk-QMINRHT5.js";
import {
  require_prop_types
} from "./chunk-VYJ7ZLU3.js";
import {
  require_react
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime5.jsx)(React15.Fragment, {
    children: React15.cloneElement(children2, childrenProps)
  });
}
...
var Portal = React34.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React34.isValidElement(children2) ? children2.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React34.isValidElement(children2)) {
      const newProps = {
        ref: handleRef
      };
      return React34.cloneElement(children2, newProps);
    }
  ...
  return (0, import_jsx_runtime18.jsx)(Portal, {
    ...
    children: (0, import_jsx_runtime19.jsxs)(Root, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime18.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime18.jsx)(FocusTrap, {
        ...
        open,
        children: React43.cloneElement(children2, childProps)
      })]
    }))
  });
});
...
var Popup = React52.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children: children2,
...
function useSelect(props) {
  ...
  const optionValues = React53.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React53.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React53.useCallback((valueToCheck) => {
  ...
  const getItemId = React53.useCallback((itemValue) => {
    var _options$get;
    return (_options$get = options.get(itemValue)) == null ? void 0 : _options$get.id;
  }, [options]);
  const handleSelectionChange = React53.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React53.useCallback((event, newValue) => {
    onHighlightChange == null || onHighlightChange(event, newValue != null ? newValue : null);
  }, [onHighlightChange]);
  const handleStateChange = React53.useCallback((event, field, fieldValue) => {
    if (field === "open") {
  ...
  const getOptionMetadata = React53.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
  ...
  const contextValue = React53.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime28.jsx)(React55.Fragment, {
...
var Select = React55.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsxs)(React55.Fragment, {
...
function useSlider(parameters) {
  ...
  values3 = values3.map((value) => clamp3(value, min2, max2));
  ...
  const createHandleHiddenInputChange = (otherHandlers) => (event) => {
    ...
    if (range) {
      if (disableSwap) {
        newValue = clamp3(newValue, values3[index2 - 1] || -Infinity, values3[index2 + 1] || Infinity);
      }
  ...
  const getFingerNewValue = ({
    ...
    if (range) {
      ...
      if (disableSwap) {
        newValue = clamp3(newValue, values3[activeIndex - 1] || -Infinity, values3[activeIndex + 1] || Infinity);
      }
      const previousValue = newValue;
      newValue = setValueIndex({
        values: values3,
...
function useSnackbar(parameters = {}) {
  ...
  const timerAutoHide = React58.useRef();
  React58.useEffect(() => {
    if (!open) {
      return void 0;
    }
  ...
  const handleResume = React58.useCallback(() => {
...
var Snackbar = React59.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children: children2,
    disableWindowBlurListener = false,
...
var Switch = React61.forwardRef(function Switch2(props, forwardedRef) {
...
var TablePaginationActions = React62.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var TablePagination = React63.forwardRef(function TablePagination2(props, forwardedRef) {
...
function useTabs(parameters) {
  ...
  const onSelected = React64.useCallback((event, newValue) => {
    setValue(newValue);
    onChange == null || onChange(event, newValue);
  }, [onChange, setValue]);
  const {
  ...
  const tabIdLookup = React64.useRef(() => void 0);
  const getTabPanelId = React64.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React64.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React64.useCallback((lookupFunction) => {
...
var TabsContext = React65.createContext(null);
if (true) {
  TabsContext.displayName = "TabsContext";
}
function useTabsContext() {
  const context = React65.useContext(TabsContext);
  if (context == null) {
...
function TabsProvider(props) {
  ...
  const tabsContextValue = React66.useMemo(() => ({
    direction,
    getTabId,
    getTabPanelId,
    onSelected,
...
var Tabs = React67.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children: children2,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React68.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React69.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children: children2,
    slotProps = {},
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React70.useCallback((tabValue) => {
    var _subitems$get;
    return (_subitems$get = subitems.get(tabValue)) == null ? void 0 : _subitems$get.id;
  }, [subitems]);
  registerTabIdLookup(tabIdLookup);
  const subitemKeys = React70.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getTabElement = React70.useCallback((tabValue) => {
  ...
  const handleChange = React70.useCallback((event, newValue) => {
    var _newValue$;
    onSelected(event, (_newValue$ = newValue[0]) != null ? _newValue$ : null);
  }, [onSelected]);
  const controlledProps = React70.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React70.useCallback((item) => {
  ...
  const {
    ...
    reducerActionContext: React70.useMemo(() => ({
  ...
  const contextValue = React70.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
function TabsListProvider(props) {
  ...
  const listContextValue = React71.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
  }), [dispatch, getItemIndex, getItemState]);
  const compoundComponentContextValue = React71.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  }), [registerItem, getItemIndex, totalSubitemCount]);
...
var TabsList = React72.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children: children2,
    slotProps = {},
...
function useTab(parameters) {
  ...
  const tabRef = React73.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React73.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var Tab = React74.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children: children2,
    disabled = false,
...
var TextareaAutosize = React75.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const shadowRef = React75.useRef(null);
  const renders = React75.useRef(0);
  const [state, setState] = React75.useState({
    outerHeightStyle: 0
  });
  const getUpdatedState = React75.useCallback(() => {
  ...
  const syncHeight = React75.useCallback(() => {
  ...
  return (0, import_jsx_runtime46.jsxs)(React75.Fragment, {
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React76.useRef(false);
  const firstFocus = React76.useRef(true);
  const inputRef = React76.useRef(null);
  const listboxRef = React76.useRef(null);
  const [anchorEl, setAnchorEl] = React76.useState(null);
  const [focusedTag, setFocusedTag] = React76.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React76.useRef(defaultHighlighted);
  ...
  const resetInputValue = React76.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React76.useState(true);
  ...
  const syncHighlightedIndex = React76.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React76.useRef(false);
      ...
      case 0:
        switch (character2) {
          ...
          case 59:
            characters2 += ";";
          default:
            append(reference = ruleset(characters2, root, parent, index2, offset2, rules, points, type, props = [], children2 = [], length2), rulesets);
            if (character2 === 123)
              if (offset2 === 0)
...
function ruleset(value, root, parent, index2, offset2, rules, points, type, props, children2, length2) {
  var post = offset2 - 1;
...
var useInsertionEffect2 = React77["useInsertionEffect"] ? React77["useInsertionEffect"] : false;
var useInsertionEffectAlwaysWithSyncFallback = useInsertionEffect2 || syncFallback;
var useInsertionEffectWithLayoutFallback = useInsertionEffect2 || React77.useLayoutEffect;

// node_modules/@emotion/react/dist/emotion-element-c39617d8.browser.esm.js
var isBrowser2 = true;
var hasOwnProperty = {}.hasOwnProperty;
var EmotionCacheContext = React78.createContext(
  ...
  withEmotionCache = function withEmotionCache3(func) {
    return function(props) {
      ...
      if (cache2 === null) {
        ...
        return React78.createElement(EmotionCacheContext.Provider, {
          value: cache2
        }, func(props, cache2));
      } else {
...
var ThemeContext = React78.createContext({});
if (true) {
...
var Emotion = withEmotionCache(function(props, cache2, ref) {
  ...
  var serialized = serializeStyles(registeredStyles, void 0, React78.useContext(ThemeContext));
  ...
  return React78.createElement(React78.Fragment, null, React78.createElement(Insertion, {
    cache: cache2,
    serialized,
    isStringTag: typeof WrappedComponent === "string"
  }), React78.createElement(WrappedComponent, newProps));
});
if (true) {
...
var Global = withEmotionCache(function(props, cache2) {
  ...
  var serialized = serializeStyles([styles2], void 0, React79.useContext(ThemeContext));
  if (!isBrowser2) {
    var _ref;
    ...
    return React79.createElement("style", (_ref = {}, _ref["data-emotion"] = cache2.key + "-global " + serializedNames, _ref.dangerouslySetInnerHTML = {
      __html: rules
    }, _ref.nonce = cache2.sheet.nonce, _ref));
  }
  var sheetRef = React79.useRef();
...
var ClassNames = withEmotionCache(function(props, cache2) {
  ...
  var content = {
    css: css2,
    cx,
    theme: React79.useContext(ThemeContext)
  };
  var ele = props.children(content);
  hasRendered = true;
  return React79.createElement(React79.Fragment, null, React79.createElement(Insertion3, {
    cache: cache2,
    serializedArr
  }), ele);
});
  ...
  return function() {
    ...
    var Styled = withEmotionCache(function(props, cache2, ref) {
      ...
      if (props.theme == null) {
        ...
        mergedProps.theme = React80.useContext(ThemeContext);
      }
      if (typeof props.className === "string") {
      ...
      newProps.className = className;
      newProps.ref = ref;
      return React80.createElement(React80.Fragment, null, React80.createElement(Insertion5, {
        cache: cache2,
        serialized,
        isStringTag: typeof FinalTag === "string"
      }), React80.createElement(FinalTag, newProps));
    });
...
function StyledEngineProvider(props) {
  ...
  return injectFirst && cache ? (0, import_jsx_runtime47.jsx)(CacheProvider, {
    value: cache,
    children: children2
  }) : children2;
}
...
function GlobalStyles(props) {
  ...
  const globalStyles = typeof styles2 === "function" ? (themeInput) => styles2(isEmpty2(themeInput) ? defaultTheme6 : themeInput) : styles2;
  return (0, import_jsx_runtime48.jsx)(Global, {
    styles: globalStyles
  });
}
true ? GlobalStyles.propTypes = {
  defaultTheme: import_prop_types33.default.object,
  styles: import_prop_types33.default.oneOfType([import_prop_types33.default.array, import_prop_types33.default.string, import_prop_types33.default.object, import_prop_types33.default.func])
} : void 0;
...
var responsivePropType = true ? import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string, import_prop_types34.default.object, import_prop_types34.default.array]) : {};
...
function useTheme2(defaultTheme6 = null) {
  const contextTheme = React83.useContext(ThemeContext);
...
function GlobalStyles2({
  ...
  return (0, import_jsx_runtime49.jsx)(GlobalStyles, {
    styles: globalStyles
  });
}
true ? GlobalStyles2.propTypes = {
   ...
   * @ignore
   */
  defaultTheme: import_prop_types36.default.object,
  /**
   * @ignore
   */
...
function createBox(options = {}) {
  ...
  const Box2 = React85.forwardRef(function Box3(inProps, ref) {
    const theme = useTheme_default(defaultTheme6);
    const _extendSxProp = extendSxProp(inProps), {
      className,
      component = "div"
    } = _extendSxProp, other = _objectWithoutPropertiesLoose(_extendSxProp, _excluded30);
    return (0, import_jsx_runtime50.jsx)(BoxRoot, _extends({
      as: component,
      ref,
...
function resolveTheme({
  ...
  return isEmpty4(theme) ? defaultTheme6 : theme[themeId] || theme;
}
...
var ThemeContext2 = React86.createContext(null);
if (true) {
...
function useTheme4() {
  const theme = React87.useContext(ThemeContext_default);
  if (true) {
...
function ThemeProvider2(props) {
  ...
  return (0, import_jsx_runtime51.jsx)(ThemeContext_default.Provider, {
    value: theme,
    children: children2
  });
}
true ? ThemeProvider2.propTypes = {
   ...
   */
  theme: import_prop_types38.default.oneOfType([import_prop_types38.default.object, import_prop_types38.default.func]).isRequired
} : void 0;
if (true) {
...
function ThemeProvider3(props) {
  ...
  return (0, import_jsx_runtime52.jsx)(ThemeProvider_default, {
    theme: privateTheme,
    children: (0, import_jsx_runtime52.jsx)(ThemeContext.Provider, {
      value: engineTheme,
      children: children2
    })
  });
...
true ? ThemeProvider3.propTypes = {
   ...
   * A theme object. You can provide a function to extend the outer theme.
   */
  theme: import_prop_types39.default.oneOfType([import_prop_types39.default.func, import_prop_types39.default.object]).isRequired,
  /**
   * The design system's unique id for getting the corresponded theme when there are multiple design systems.
   */
  themeId: import_prop_types39.default.string
} : void 0;
if (true) {
...
function getInitColorSchemeScript(options) {
  ...
  return (0, import_jsx_runtime53.jsx)("script", {
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React91.useCallback((mode) => {
  ...
  const setColorScheme = React91.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React91.useCallback((e) => {
  ...
  const mediaListener = React91.useRef(handleMediaQuery);
...
var _excluded33 = ["colorSchemes", "components", "generateCssVars", "cssVarPrefix"];
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React92.createContext(void 0);
  const useColorScheme2 = () => {
    const value = React92.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider2({
    ...
    const hasMounted = React92.useRef(false);
    const upperTheme = useTheme4();
    const ctx = React92.useContext(ColorSchemeContext);
    ...
    const _ref = scopedTheme || themeProp, {
      ...
      cssVarPrefix
    } = _ref, restThemeProp = _objectWithoutPropertiesLoose(_ref, _excluded33);
    ...
    const element = (0, import_jsx_runtime55.jsxs)(React92.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime55.jsxs)(React92.Fragment, {
        children: [(0, import_jsx_runtime54.jsx)(GlobalStyles, {
          styles: {
            [colorSchemeSelector]: rootCss
          }
        }), (0, import_jsx_runtime54.jsx)(GlobalStyles, {
          styles: defaultColorSchemeStyleSheet
        }), (0, import_jsx_runtime54.jsx)(GlobalStyles, {
          styles: otherColorSchemesStyleSheet
        })]
      }), (0, import_jsx_runtime54.jsx)(ThemeProvider_default2, {
    ...
    return (0, import_jsx_runtime54.jsx)(ColorSchemeContext.Provider, {
      value: contextValue,
      children: element
    });
  }
  true ? CssVarsProvider2.propTypes = {
     ...
     */
    attribute: import_prop_types40.default.string,
    /**
     * The component tree.
     */
     ...
     */
    colorSchemeNode: import_prop_types40.default.any,
    /**
     * The CSS selector for attaching the generated custom properties
     */
    colorSchemeSelector: import_prop_types40.default.string,
    /**
     * localStorage key used to store `colorScheme`
     */
    colorSchemeStorageKey: import_prop_types40.default.string,
    /**
     * The initial color scheme used.
     */
    defaultColorScheme: import_prop_types40.default.oneOfType([import_prop_types40.default.string, import_prop_types40.default.object]),
    /**
     * The initial mode used.
     */
    defaultMode: import_prop_types40.default.string,
    /**
     * If `true`, the provider creates its own context and generate stylesheet as if it is a root `CssVarsProvider`.
     */
    disableNestedContext: import_prop_types40.default.bool,
    /**
     * If `true`, the style sheet won't be generated.
     *
     * This is useful for controlling nested CssVarsProvider behavior.
     */
    disableStyleSheetGeneration: import_prop_types40.default.bool,
    /**
     * Disable CSS transitions when switching between modes or color schemes.
     */
    disableTransitionOnChange: import_prop_types40.default.bool,
    /**
     * The document to attach the attribute to.
     */
    documentNode: import_prop_types40.default.any,
    /**
     * The key in the local storage used to store current color scheme.
     */
    modeStorageKey: import_prop_types40.default.string,
    /**
     * The window that attaches the 'storage' event listener.
     * @default window
     */
    storageWindow: import_prop_types40.default.any,
    /**
...
var _excluded34 = ["colorSchemes", "components"];
var _excluded210 = ["light"];
function prepareCssVars(theme, parserConfig) {
  const {
    colorSchemes = {}
  } = theme, otherTheme = _objectWithoutPropertiesLoose(theme, _excluded34);
  const {
    vars: rootVars,
    css: rootCss,
...
var _excluded35 = ["className", "component", "disableGutters", "fixed", "maxWidth", "classes"];
...
function createContainer(options = {}) {
  ...
  const Container2 = React93.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime56.jsx)(ContainerRoot, _extends({
        as: component,
        ownerState,
...
var _excluded36 = ["className", "children", "columns", "container", "component", "direction", "wrap", "spacing", "rowSpacing", "columnSpacing", "disableEqualOverflow", "unstable_level"];
...
function createGrid(options = {}) {
  ...
  const OverflowContext = React94.createContext(void 0);
  const useUtilityClasses32 = (ownerState, theme) => {
    const {
      container,
      direction,
      spacing: spacing2,
  ...
  const Grid2 = React94.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React94.useContext(OverflowContext);
    const {
      className,
      children: children2,
    ...
    } = props, rest = _objectWithoutPropertiesLoose(props, _excluded36);
    ...
    const classes = useUtilityClasses32(ownerState, theme);
    let result = (0, import_jsx_runtime57.jsx)(GridRoot, _extends({
      ref,
      as: component,
      ownerState,
      className: clsx_default3(classes.root, className)
      ...
      children: React94.Children.map(children2, (child) => {
        if (React94.isValidElement(child) && isMuiElement(child, ["Grid"])) {
    ...
    if (disableEqualOverflow !== void 0 && disableEqualOverflow !== (overflow2 != null ? overflow2 : false)) {
      result = (0, import_jsx_runtime57.jsx)(OverflowContext.Provider, {
  ...
  true ? Grid2.propTypes = {
    ...
    disableEqualOverflow: import_prop_types43.default.bool,
    ...
    lgOffset: import_prop_types43.default.oneOfType([import_prop_types43.default.oneOf(["auto"]), import_prop_types43.default.number]),
    ...
    mdOffset: import_prop_types43.default.oneOfType([import_prop_types43.default.oneOf(["auto"]), import_prop_types43.default.number]),
    ...
    smOffset: import_prop_types43.default.oneOfType([import_prop_types43.default.oneOf(["auto"]), import_prop_types43.default.number]),
    ...
    xlOffset: import_prop_types43.default.oneOfType([import_prop_types43.default.oneOf(["auto"]), import_prop_types43.default.number]),
    ...
    xsOffset: import_prop_types43.default.oneOfType([import_prop_types43.default.oneOf(["auto"]), import_prop_types43.default.number])
  } : void 0;
  Grid2.muiName = "Grid";
  return Grid2;
}
...
true ? Grid.propTypes = {
   ...
   */
  disableEqualOverflow: import_prop_types44.default.bool,
  /**
   ...
   * The value is applied for the `lg` breakpoint and wider screens if not overridden.
   */
  lgOffset: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["auto"]), import_prop_types44.default.number]),
  /**
   * If a number, it sets the number of columns the grid item uses.
   * It can't be greater than the total number of columns of the container (12 by default).
   * If 'auto', the grid item's width matches its content.
   ...
   * The value is applied for the `md` breakpoint and wider screens if not overridden.
   */
  mdOffset: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["auto"]), import_prop_types44.default.number]),
  /**
   ...
   * The value is applied for the `sm` breakpoint and wider screens if not overridden.
   */
  smOffset: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["auto"]), import_prop_types44.default.number]),
  /**
   ...
   * The value is applied for the `xl` breakpoint and wider screens if not overridden.
   */
  xlOffset: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["auto"]), import_prop_types44.default.number]),
  /**
   * If a number, it sets the number of columns the grid item uses.
   * It can't be greater than the total number of columns of the container (12 by default).
   * If 'auto', the grid item's width matches its content.
   ...
   */
  xsOffset: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["auto"]), import_prop_types44.default.number])
} : void 0;
...
var _excluded37 = ["component", "direction", "spacing", "divider", "children", "className", "useFlexGap"];
...
function joinChildren(children2, separator) {
  const childrenArray = React95.Children.toArray(children2).filter(Boolean);
...
function createStack(options = {}) {
  ...
  const Stack2 = React95.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
    ...
    return (0, import_jsx_runtime58.jsx)(StackRoot, _extends({
      as: component,
      ownerState,
      ref,
      className: clsx_default3(classes.root, className)
...
var _excluded38 = ["defaultProps", "mixins", "overrides", "palette", "props", "styleOverrides"];
var _excluded211 = ["type", "mode"];
function adaptV4Theme(inputTheme) {
  ...
  const {
    ...
    props = {},
    styleOverrides = {}
  } = inputTheme, other = _objectWithoutPropertiesLoose(inputTheme, _excluded38);
  ...
  const {
    type: typeInput,
    mode: modeInput
  } = palette2, paletteRest = _objectWithoutPropertiesLoose(palette2, _excluded211);
...
var _excluded39 = ["mode", "contrastThreshold", "tonalOffset"];
var light = {
...
function createPalette(palette2) {
  const {
    ...
    contrastThreshold = 3,
    tonalOffset = 0.2
  } = palette2, other = _objectWithoutPropertiesLoose(palette2, _excluded39);
...
var _excluded40 = ["fontFamily", "fontSize", "fontWeightLight", "fontWeightRegular", "fontWeightMedium", "fontWeightBold", "htmlFontSize", "allVariants", "pxToRem"];
...
function createTypography(palette2, typography2) {
  ...
  const buildVariant = (fontWeight2, size2, lineHeight2, letterSpacing2, casing) => _extends({
    ...
    letterSpacing: `${round2(letterSpacing2 / size2)}em`
  } : {}, casing, allVariants);
  const variants = {
...
var _excluded41 = ["duration", "easing", "delay"];
var easing = {
...
function createTransitions(inputTransitions) {
  ...
  const create = (props = ["all"], options = {}) => {
    const {
      ...
      delay = 0
    } = options, other = _objectWithoutPropertiesLoose(options, _excluded41);
    if (true) {
...
var _excluded42 = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function createTheme2(options = {}, ...args) {
  ...
  } = options, other = _objectWithoutPropertiesLoose(options, _excluded42);
  if (options.vars) {
...
var _excluded43 = ["theme"];
function ThemeProvider4(_ref) {
  let {
    theme: themeInput
  } = _ref, props = _objectWithoutPropertiesLoose(_ref, _excluded43);
  const scopedTheme = themeInput[identifier_default];
  return (0, import_jsx_runtime59.jsx)(ThemeProvider_default2, _extends({}, props, {
...
true ? ThemeProvider4.propTypes = {
   ...
   * A theme object. You can provide a function to extend the outer theme.
   */
  theme: import_prop_types47.default.oneOfType([import_prop_types47.default.object, import_prop_types47.default.func]).isRequired
} : void 0;
...
var _excluded44 = ["colorSchemes", "cssVarPrefix", "shouldSkipGeneratingVar"];
...
var excludeVariablesFromRoot = (cssVarPrefix) => [...[...Array(24)].map((_2, index2) => `--${cssVarPrefix ? `${cssVarPrefix}-` : ""}overlays-${index2 + 1}`), `--${cssVarPrefix ? `${cssVarPrefix}-` : ""}palette-AppBar-darkBg`, `--${cssVarPrefix ? `${cssVarPrefix}-` : ""}palette-AppBar-darkColor`];
...
var _excluded45 = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"];
var PopperRoot = styled_default2(Popper, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (props, styles2) => styles2.root
})({});
var Popper3 = React98.forwardRef(function Popper4(inProps, ref) {
  var _slots$root;
  ...
  return (0, import_jsx_runtime60.jsx)(PopperRoot, _extends({
    as: component,
...
var ListSubheader = React99.forwardRef(function ListSubheader2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiListSubheader"
  });
  ...
  return (0, import_jsx_runtime61.jsx)(ListSubheaderRoot, _extends({
    as: component,
...
var _excluded47 = ["className", "component", "elevation", "square", "variant"];
...
var Paper = React100.forwardRef(function Paper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime62.jsx)(PaperRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
TransitionGroup.propTypes = true ? {
   ...
   */
  component: import_prop_types52.default.any,
  /**
   ...
   * on individual children Transitions.
   */
  enter: import_prop_types52.default.bool,
  /**
   * A convenience prop that enables or disables exit animations
   * for all children. Note that specifying this will override any defaults set
   * on individual children Transitions.
   */
  exit: import_prop_types52.default.bool,
  /**
   ...
   */
  childFactory: import_prop_types52.default.func
} : {};
...
ReplaceTransition.propTypes = true ? {
  in: import_prop_types53.default.bool.isRequired,
...
SwitchTransition.propTypes = true ? {
   ...
   * @type {'out-in'|'in-out'}
   */
  mode: import_prop_types54.default.oneOf([modes.in, modes.out]),
  /**
   * Any `Transition` or `CSSTransition` component.
   */
  children: import_prop_types54.default.oneOfType([import_prop_types54.default.element.isRequired])
} : {};
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React105.useState(false);
...
true ? Ripple.propTypes = {
   ...
   */
  pulsate: import_prop_types55.default.bool,
  /**
   * Diameter of the ripple.
   */
  rippleSize: import_prop_types55.default.number,
  /**
   * Horizontal position of the ripple center.
   */
  rippleX: import_prop_types55.default.number,
  /**
   * Vertical position of the ripple center.
   */
  rippleY: import_prop_types55.default.number,
  /**
   * exit delay
   */
  timeout: import_prop_types55.default.number.isRequired
} : void 0;
...
var _excluded48 = ["center", "classes", "className"];
var _ = (t) => t;
var _t;
var _t2;
var _t3;
...
var TouchRipple = React106.forwardRef(function TouchRipple2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiTouchRipple"
  });
  ...
  const [ripples, setRipples] = React106.useState([]);
  const nextKey = React106.useRef(0);
  const rippleCallback = React106.useRef(null);
  React106.useEffect(() => {
  ...
  const ignoringMouseDown = React106.useRef(false);
  const startTimer = React106.useRef(0);
  const startTimerCommit = React106.useRef(null);
  const container = React106.useRef(null);
  React106.useEffect(() => {
    return () => {
  ...
  const startCommit = React106.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
    ...
    setRipples((oldRipples) => [...oldRipples, (0, import_jsx_runtime64.jsx)(TouchRippleRipple, {
      classes: {
  ...
  const start = React106.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  const pulsate = React106.useCallback(() => {
    start({}, {
      pulsate: true
    });
  }, [start]);
  const stop = React106.useCallback((event, cb) => {
    clearTimeout(startTimer.current);
  ...
  React106.useImperativeHandle(ref, () => ({
    pulsate,
    start,
    stop
  }), [pulsate, start, stop]);
  return (0, import_jsx_runtime64.jsx)(TouchRippleRoot, _extends({
    className: clsx_default(touchRippleClasses_default.root, classes.root, className),
    ref: container
  }, other, {
    children: (0, import_jsx_runtime64.jsx)(TransitionGroup_default, {
      component: null,
      exit: true,
      children: ripples
    })
...
true ? TouchRipple.propTypes = {
   ...
   */
  center: import_prop_types56.default.bool,
  /**
   * Override or extend the styles applied to the component.
   * See [CSS API](#css) below for more details.
   */
...
var _excluded49 = ["action", "centerRipple", "children", "className", "component", "disabled", "disableRipple", "disableTouchRipple", "focusRipple", "focusVisibleClassName", "LinkComponent", "onBlur", "onClick", "onContextMenu", "onDragLeave", "onFocus", "onFocusVisible", "onKeyDown", "onKeyUp", "onMouseDown", "onMouseLeave", "onMouseUp", "onTouchEnd", "onTouchMove", "onTouchStart", "tabIndex", "TouchRippleProps", "touchRippleRef", "type"];
...
var ButtonBase = React107.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  const rippleRef = React107.useRef(null);
  ...
  const [focusVisible, setFocusVisible] = React107.useState(false);
  if (disabled && focusVisible) {
    setFocusVisible(false);
  }
  ...
  const [mountedState, setMountedState] = React107.useState(false);
  React107.useEffect(() => {
    setMountedState(true);
  }, []);
  ...
  const keydownRef = React107.useRef(false);
  ...
  return (0, import_jsx_runtime66.jsxs)(ButtonBaseRoot, _extends({
    as: ComponentProp,
    className: clsx_default(classes.root, className),
    ownerState,
    onBlur: handleBlur2,
    ...
    children: [children2, enableTouchRipple ? (
      ...
      (0, import_jsx_runtime65.jsx)(TouchRipple_default, _extends({
        ref: handleRippleRef,
        center: centerRipple
      }, TouchRippleProps))
    ) : null]
...
true ? ButtonBase.propTypes = {
   ...
   * @default false
   */
  centerRipple: import_prop_types57.default.bool,
  /**
   * The content of the component.
   */
   ...
   * @default false
   */
  disableTouchRipple: import_prop_types57.default.bool,
  /**
   * If `true`, the base button will have a keyboard focus ripple.
   * @default false
   */
  focusRipple: import_prop_types57.default.bool,
  /**
   ...
   * @ignore
   */
  href: import_prop_types57.default.any,
  /**
   * The component used to render a link when the `href` prop is provided.
   * @default 'a'
   */
  LinkComponent: import_prop_types57.default.elementType,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  onContextMenu: import_prop_types57.default.func,
  /**
   * @ignore
   */
  onDragLeave: import_prop_types57.default.func,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  onMouseUp: import_prop_types57.default.func,
  /**
   * @ignore
   */
  onTouchEnd: import_prop_types57.default.func,
  /**
   * @ignore
   */
  onTouchMove: import_prop_types57.default.func,
  /**
   * @ignore
   */
  onTouchStart: import_prop_types57.default.func,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   */
  TouchRippleProps: import_prop_types57.default.object,
  /**
   * A ref that points to the `TouchRipple` element.
   */
  touchRippleRef: import_prop_types57.default.oneOfType([import_prop_types57.default.func, import_prop_types57.default.shape({
    current: import_prop_types57.default.shape({
      pulsate: import_prop_types57.default.func.isRequired,
      start: import_prop_types57.default.func.isRequired,
      stop: import_prop_types57.default.func.isRequired
    })
  })]),
  /**
   * @ignore
...
var _excluded50 = ["edge", "children", "className", "color", "disabled", "disableFocusRipple", "size"];
...
var IconButton = React108.forwardRef(function IconButton2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiIconButton"
  });
  ...
  return (0, import_jsx_runtime67.jsx)(IconButtonRoot, _extends({
    className: clsx_default(classes.root, className),
    centerRipple: true,
...
true ? IconButton.propTypes = {
  ...
  children: chainPropTypes(import_prop_types58.default.node, (props) => {
    const found = React108.Children.toArray(props.children).some((child) => React108.isValidElement(child) && child.props.onClick);
    if (found) {
   ...
   * @default 'default'
   */
  color: import_prop_types58.default.oneOfType([import_prop_types58.default.oneOf(["inherit", "default", "primary", "secondary", "error", "info", "success", "warning"]), import_prop_types58.default.string]),
  /**
   * If `true`, the component is disabled.
   * @default false
   */
...
var _excluded51 = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"];
...
var SvgIcon = React109.forwardRef(function SvgIcon2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiSvgIcon"
  });
  ...
  const hasSvgAsChild = React109.isValidElement(children2) && children2.type === "svg";
  const ownerState = _extends({}, props, {
    color: color2,
    component,
    fontSize: fontSize2,
...
true ? SvgIcon.propTypes = {
   ...
   */
  htmlColor: import_prop_types59.default.string,
  /**
   ...
   * @default false
   */
  inheritViewBox: import_prop_types59.default.bool,
  /**
   * The shape-rendering attribute. The behavior of the different options is described on the
   * [MDN Web Docs](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/shape-rendering).
   * If you are having issues with blurry icons you should investigate this prop.
   */
  shapeRendering: import_prop_types59.default.string,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   */
  titleAccess: import_prop_types59.default.string,
  /**
   ...
   * @default '0 0 24 24'
   */
  viewBox: import_prop_types59.default.string
} : void 0;
...
function createSvgIcon(path, displayName) {
  ...
  return React110.memo(React110.forwardRef(Component));
}
...
var _excluded52 = ["avatar", "className", "clickable", "color", "component", "deleteIcon", "disabled", "icon", "label", "onClick", "onDelete", "onKeyDown", "onKeyUp", "size", "variant", "tabIndex", "skipFocusWhenDisabled"];
...
var ChipRoot = styled_default2("div", {
  ...
  overridesResolver: (props, styles2) => {
    ...
    return [{
      ...
      [`& .${chipClasses_default.avatar}`]: styles2[`avatar${capitalize_default(size2)}`]
    }, {
      [`& .${chipClasses_default.avatar}`]: styles2[`avatarColor${capitalize_default(color2)}`]
    }, {
      [`& .${chipClasses_default.icon}`]: styles2.icon
    }, {
      [`& .${chipClasses_default.icon}`]: styles2[`icon${capitalize_default(size2)}`]
    }, {
      [`& .${chipClasses_default.icon}`]: styles2[`iconColor${capitalize_default(iconColor)}`]
    }, {
      [`& .${chipClasses_default.deleteIcon}`]: styles2.deleteIcon
    }, {
      [`& .${chipClasses_default.deleteIcon}`]: styles2[`deleteIcon${capitalize_default(size2)}`]
    }, {
      [`& .${chipClasses_default.deleteIcon}`]: styles2[`deleteIconColor${capitalize_default(color2)}`]
    }, {
      [`& .${chipClasses_default.deleteIcon}`]: styles2[`deleteIcon${capitalize_default(variant)}Color${capitalize_default(color2)}`]
    }, styles2.root, styles2[`size${capitalize_default(size2)}`], styles2[`color${capitalize_default(color2)}`], clickable && styles2.clickable, clickable && color2 !== "default" && styles2[`clickableColor${capitalize_default(color2)})`], onDelete && styles2.deletable, onDelete && color2 !== "default" && styles2[`deletableColor${capitalize_default(color2)}`], styles2[variant], styles2[`${variant}${capitalize_default(color2)}`]];
  }
})(({
  theme,
  ownerState
...
var ChipLabel = styled_default2("span", {
  ...
  overridesResolver: (props, styles2) => {
    ...
    return [styles2.label, styles2[`label${capitalize_default(size2)}`]];
  }
})(({
  ownerState
}) => _extends({
...
var Chip = React112.forwardRef(function Chip2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiChip"
  });
  ...
  const chipRef = React112.useRef(null);
  ...
  const ownerState = _extends({}, props, {
    ...
    size: size2,
    color: color2,
    iconColor: React112.isValidElement(iconProp) ? iconProp.props.color || color2 : color2,
    onDelete: !!onDelete,
    clickable,
    variant
  });
  ...
  let deleteIcon = null;
  if (onDelete) {
    deleteIcon = deleteIconProp && React112.isValidElement(deleteIconProp) ? React112.cloneElement(deleteIconProp, {
  ...
  let avatar = null;
  if (avatarProp && React112.isValidElement(avatarProp)) {
    avatar = React112.cloneElement(avatarProp, {
      className: clsx_default(classes.avatar, avatarProp.props.className)
    });
  }
  let icon = null;
  if (iconProp && React112.isValidElement(iconProp)) {
    icon = React112.cloneElement(iconProp, {
...
true ? Chip.propTypes = {
   ...
   */
  avatar: import_prop_types60.default.element,
  /**
   ...
   */
  clickable: import_prop_types60.default.bool,
  /**
   * The color of the component.
   * It supports both default and custom theme colors, which can be added as shown in the
   * [palette customization guide](https://mui.com/material-ui/customization/palette/#custom-colors).
   ...
   */
  deleteIcon: import_prop_types60.default.element,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   * Icon element.
   */
  icon: import_prop_types60.default.element,
  /**
   * The content of the component.
   */
   ...
   */
  onDelete: import_prop_types60.default.func,
  /**
   * @ignore
   */
   ...
   * @default false
   */
  skipFocusWhenDisabled: import_prop_types60.default.bool,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   * @default 'filled'
   */
  variant: import_prop_types60.default.oneOfType([import_prop_types60.default.oneOf(["filled", "outlined"]), import_prop_types60.default.string])
} : void 0;
...
var FormControlContext2 = React113.createContext(void 0);
if (true) {
...
function useFormControl() {
  return React114.useContext(FormControlContext_default);
}
...
function GlobalStyles3(props) {
  return (0, import_jsx_runtime74.jsx)(GlobalStyles_default, _extends({}, props, {
    defaultTheme: defaultTheme_default,
    themeId: identifier_default
  }));
}
true ? GlobalStyles3.propTypes = {
   ...
   */
  styles: import_prop_types61.default.oneOfType([import_prop_types61.default.array, import_prop_types61.default.func, import_prop_types61.default.number, import_prop_types61.default.object, import_prop_types61.default.string, import_prop_types61.default.bool])
} : void 0;
...
var _excluded53 = ["aria-describedby", "autoComplete", "autoFocus", "className", "color", "components", "componentsProps", "defaultValue", "disabled", "disableInjectingGlobalStyles", "endAdornment", "error", "fullWidth", "id", "inputComponent", "inputProps", "inputRef", "margin", "maxRows", "minRows", "multiline", "name", "onBlur", "onChange", "onClick", "onFocus", "onKeyDown", "onKeyUp", "placeholder", "readOnly", "renderSuffix", "rows", "size", "slotProps", "slots", "startAdornment", "type", "value"];
...
var inputGlobalStyles = (0, import_jsx_runtime75.jsx)(GlobalStyles_default2, {
  styles: {
...
var InputBase = React116.forwardRef(function InputBase2(inProps, ref) {
  ...
  const inputRef = React116.useRef();
  const handleInputRefWarning = React116.useCallback((instance) => {
    if (true) {
      if (instance && instance.nodeName !== "INPUT" && !instance.focus) {
  ...
  const [focused, setFocused] = React116.useState(false);
  ...
  const checkDirty = React116.useCallback((obj) => {
    if (isFilled(obj)) {
      if (onFilled) {
        onFilled();
      }
  ...
  return (0, import_jsx_runtime76.jsxs)(React116.Fragment, {
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, (0, import_jsx_runtime76.jsxs)(Root, _extends({}, rootProps, !isHostComponent(Root) && {
...
true ? InputBase.propTypes = {
   ...
   * @default false
   */
  disableInjectingGlobalStyles: import_prop_types62.default.bool,
  /**
   ...
   */
  onInvalid: import_prop_types62.default.func,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  onKeyUp: import_prop_types62.default.func,
  /**
   * The short hint displayed in the `input` before the user enters a value.
   */
   ...
   * @ignore
   */
  renderSuffix: import_prop_types62.default.func,
  /**
   * If `true`, the `input` element is required.
   * The prop defaults to the value (`false`) inherited from the parent FormControl component.
   */
...
var Close_default = createSvgIcon((0, import_jsx_runtime77.jsx)("path", {
...
var AutocompleteRoot = styled_default2("div", {
  ...
  overridesResolver: (props, styles2) => {
    ...
    return [{
      ...
      [`& .${autocompleteClasses_default.tag}`]: styles2[`tagSize${capitalize_default(size2)}`]
    }, {
...
var Autocomplete = React119.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  const {
    ...
    ChipProps,
    className,
    clearIcon = _ClearIcon || (_ClearIcon = (0, import_jsx_runtime79.jsx)(Close_default, {
      fontSize: "small"
    })),
    clearOnBlur = !props.freeSolo,
    clearOnEscape = false,
    ...
    popupIcon = _ArrowDropDownIcon || (_ArrowDropDownIcon = (0, import_jsx_runtime79.jsx)(ArrowDropDown_default, {})),
    readOnly = false,
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map((option, index2) => (0, import_jsx_runtime79.jsx)(Chip_default, _extends({
  ...
  if (limitTags > -1 && Array.isArray(startAdornment)) {
    ...
    if (!focused && more > 0) {
      ...
      startAdornment.push((0, import_jsx_runtime79.jsx)("span", {
        className: classes.tag,
        children: getLimitTagsText(more)
      }, startAdornment.length));
    }
  }
  const defaultRenderGroup = (params) => (0, import_jsx_runtime80.jsxs)("li", {
    children: [(0, import_jsx_runtime79.jsx)(AutocompleteGroupLabel, {
      className: classes.groupLabel,
      ownerState,
      component: "div",
      children: params.group
    }), (0, import_jsx_runtime79.jsx)(AutocompleteGroupUl, {
  ...
  const defaultRenderOption = (props2, option) => {
    const {
      key
    } = props2, otherProps = _objectWithoutPropertiesLoose(props2, _excluded310);
    return (0, import_jsx_runtime79.jsx)("li", _extends({}, otherProps, {
  ...
  return (0, import_jsx_runtime80.jsxs)(React119.Fragment, {
    children: [(0, import_jsx_runtime79.jsx)(AutocompleteRoot, _extends({
      ref,
      className: clsx_default(classes.root, className),
      ownerState
    }, getRootProps(other), {
      children: renderInput({
        ...
        InputProps: _extends({
          ...
          endAdornment: (0, import_jsx_runtime80.jsxs)(AutocompleteEndAdornment, {
            className: classes.endAdornment,
            ownerState,
            children: [hasClearIcon ? (0, import_jsx_runtime79.jsx)(AutocompleteClearIndicator, _extends({}, getClearProps(), {
              ...
              children: clearIcon
            })) : null, hasPopupIcon ? (0, import_jsx_runtime79.jsx)(AutocompletePopupIndicator, _extends({}, getPopupIndicatorProps(), {
              disabled,
    ...
    })), anchorEl ? (0, import_jsx_runtime79.jsx)(AutocompletePopper, _extends({
      as: PopperComponent,
      disablePortal,
      style: {
      ...
      children: (0, import_jsx_runtime80.jsxs)(AutocompletePaper, _extends({
        ownerState,
        as: PaperComponent
      }, paperSlotProps, {
        className: clsx_default(classes.paper, paperSlotProps == null ? void 0 : paperSlotProps.className),
        children: [loading && groupedOptions.length === 0 ? (0, import_jsx_runtime79.jsx)(AutocompleteLoading, {
          className: classes.loading,
          ownerState,
          children: loadingText
        }) : null, groupedOptions.length === 0 && !freeSolo && !loading ? (0, import_jsx_runtime79.jsx)(AutocompleteNoOptions, {
        ...
        }) : null, groupedOptions.length > 0 ? (0, import_jsx_runtime79.jsx)(AutocompleteListbox, _extends({
          as: ListboxComponent,
          className: classes.listbox,
          ownerState
...
true ? Autocomplete.propTypes = {
   ...
   * @default false
   */
  autoComplete: import_prop_types63.default.bool,
  /**
   * If `true`, the first option is automatically highlighted.
   * @default false
   */
  autoHighlight: import_prop_types63.default.bool,
  /**
   ...
   * @default false
   */
  autoSelect: import_prop_types63.default.bool,
  /**
   ...
   * @default false
   */
  blurOnSelect: import_prop_types63.default.oneOfType([import_prop_types63.default.oneOf(["mouse", "touch"]), import_prop_types63.default.bool]),
  /**
   * Props applied to the [`Chip`](/material-ui/api/chip/) element.
   */
  ChipProps: import_prop_types63.default.object,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   */
  clearIcon: import_prop_types63.default.node,
  /**
   ...
   */
  clearOnBlur: import_prop_types63.default.bool,
  /**
   * If `true`, clear all values when the user presses escape and the popup is closed.
   * @default false
   */
  clearOnEscape: import_prop_types63.default.bool,
  /**
   ...
   * @default 'Clear'
   */
  clearText: import_prop_types63.default.string,
  /**
   ...
   * @default 'Close'
   */
  closeText: import_prop_types63.default.string,
  /**
   * The props used for each slot inside.
   * @default {}
   */
  componentsProps: import_prop_types63.default.shape({
    clearIndicator: import_prop_types63.default.object,
    paper: import_prop_types63.default.object,
    popper: import_prop_types63.default.object,
    popupIndicator: import_prop_types63.default.object
  }),
  /**
   * The default value. Use when the component is not controlled.
   * @default props.multiple ? [] : null
   */
  defaultValue: chainPropTypes(import_prop_types63.default.any, (props) => {
   ...
   * @default false
   */
  disableClearable: import_prop_types63.default.bool,
  /**
   * If `true`, the popup won't close when a value is selected.
   * @default false
   */
  disableCloseOnSelect: import_prop_types63.default.bool,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   * @returns {Value[]}
   */
  filterOptions: import_prop_types63.default.func,
  /**
   * If `true`, hide the selected options from the list box.
   * @default false
   */
  filterSelectedOptions: import_prop_types63.default.bool,
  /**
   * Force the visibility display of the popup icon.
   * @default 'auto'
   */
  forcePopupIcon: import_prop_types63.default.oneOfType([import_prop_types63.default.oneOf(["auto"]), import_prop_types63.default.bool]),
  /**
   * If `true`, the Autocomplete is free solo, meaning that the user input is not bound to provided options.
   * @default false
   */
  freeSolo: import_prop_types63.default.bool,
  /**
   * If `true`, the input will take up the full width of its container.
   * @default false
   */
   ...
   * @default (more) => `+${more}`
   */
  getLimitTagsText: import_prop_types63.default.func,
  /**
   ...
   * @returns {boolean}
   */
  getOptionDisabled: import_prop_types63.default.func,
  /**
   ...
   */
  getOptionLabel: import_prop_types63.default.func,
  /**
   ...
   * @returns {string}
   */
  groupBy: import_prop_types63.default.func,
  /**
   * If `true`, the component handles the "Home" and "End" keys when the popup is open.
   * It should move focus to the first option and last option, respectively.
   * @default !props.freeSolo
   */
  handleHomeEndKeys: import_prop_types63.default.bool,
  /**
   ...
   * @default false
   */
  includeInputInList: import_prop_types63.default.bool,
  /**
   * The input value.
   */
  inputValue: import_prop_types63.default.string,
  /**
   ...
   * @returns {boolean}
   */
  isOptionEqualToValue: import_prop_types63.default.func,
  /**
   ...
   * @default 'ul'
   */
  ListboxComponent: import_prop_types63.default.elementType,
  /**
   * Props applied to the Listbox element.
   */
  ListboxProps: import_prop_types63.default.object,
  /**
   ...
   * @default 'Loading…'
   */
  loadingText: import_prop_types63.default.node,
  /**
   ...
   * @default 'No options'
   */
  noOptionsText: import_prop_types63.default.node,
  /**
   ...
   */
  onInputChange: import_prop_types63.default.func,
  /**
   * @ignore
   */
   ...
   * @default false
   */
  openOnFocus: import_prop_types63.default.bool,
  /**
   ...
   * @default 'Open'
   */
  openText: import_prop_types63.default.string,
  /**
   * Array of options.
   */
  options: import_prop_types63.default.array.isRequired,
  /**
   ...
   */
  popupIcon: import_prop_types63.default.node,
  /**
   ...
   * @returns {ReactNode}
   */
  renderGroup: import_prop_types63.default.func,
  /**
   * Render the input.
   *
   * @param {object} params
   ...
   * @returns {ReactNode}
   */
  renderOption: import_prop_types63.default.func,
  /**
   ...
   * @returns {ReactNode}
   */
  renderTags: import_prop_types63.default.func,
  /**
   * If `true`, the input's text is selected on focus.
   * It helps the user clear the selected value.
   * @default !props.freeSolo
   */
  selectOnFocus: import_prop_types63.default.bool,
  /**
   * The size of the component.
   * @default 'medium'
   */
   ...
   */
  value: chainPropTypes(import_prop_types63.default.any, (props) => {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BQPGCLQ5.js.map
