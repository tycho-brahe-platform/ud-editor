  ...
  "node_modules/cytoscape/dist/cytoscape.cjs.js"(exports, module) {
    ...
    var memoize = function memoize2(fn2, keyFn) {
      ...
      var memoizedFn = function memoizedFn2() {
        ...
        if (!(ret = cache2[k])) {
          ret = cache2[k] = fn2.apply(self, args);
        }
        return ret;
      };
      memoizedFn.cache = {};
            ...
            if (p2.allowGetting && value === void 0) {
              ...
              if (valid2) {
                ...
                if (p2.settingTriggersEvent) {
                  self[p2.triggerFnName](p2.settingEvent);
                }
              }
            }
      ...
      removeData: function removeData(params) {
        ...
        return function removeDataImpl(names) {
          ...
          if (string(names)) {
            ...
            if (p2.triggerEvent) {
              self[p2.triggerFnName](p2.event);
            }
    ...
    var elesfn$h = {
      classes: function classes(_classes) {
        ...
        if (_classes === void 0) {
          var ret = [];
          self[0]._private.classes.forEach(function(cls2) {
      ...
      toggleClass: function toggleClass(classes, toggle) {
        ...
        var changed = [];
        for (var i2 = 0, il = self.length; i2 < il; i2++) {
          var ele = self[i2];
    ...
    var parse = function parse2(selector) {
      ...
      for (var i2 = 0; i2 < self.length; i2++) {
        var q = self[i2];
    ...
    var filter = function filter2(collection2) {
      ...
      if (self.length === 1 && self[0].checks.length === 1 && self[0].checks[0].type === Type.ID) {
        return collection2.getElementById(self[0].checks[0].value).collection();
      }
    ...
    var forEachEvent = function forEachEvent2(self, handler, events, qualifier, callback, conf, confOverrides) {
      if (fn$6(qualifier)) {
        callback = qualifier;
        qualifier = null;
      }
    ...
    var makeEventObj = function makeEventObj2(self, obj) {
      self.addEventFields(self.context, obj);
      return new Event(obj.type, obj);
    };
    var forEachEventObj = function forEachEventObj2(self, handler, events) {
      if (event(events)) {
        handler(self, events);
        return;
    ...
    p.on = p.addListener = function(events, qualifier, callback, conf, confOverrides) {
      forEachEvent(this, function(self, event2, type, namespace, qualifier2, callback2, conf2) {
        if (fn$6(callback2)) {
          self.listeners.push({
            event: event2,
            // full event string
    ...
    p.removeListener = p.off = function(events, qualifier, callback, conf) {
      ...
      var _loop = function _loop2(i3) {
        ...
        forEachEvent(_this, function(self, event2, type, namespace, qualifier2, callback2) {
          if ((listener.type === type || events === "*") && (!namespace && listener.namespace !== ".*" || listener.namespace === namespace) && (!qualifier2 || self.qualifierCompare(listener.qualifier, qualifier2)) && (!callback2 || listener.callback === callback2)) {
    ...
    elesfn$1.remove = function() {
      ...
      for (var i2 = 0, l = self.length; i2 < l; i2++) {
        var ele = self[i2];
        add(ele);
      }
    ...
    styfn$8.getPropertiesDiff = function(oldCxtKey, newCxtKey) {
      var self = this;
      var cache2 = self._private.propDiffs = self._private.propDiffs || {};
      ...
      for (var i2 = 0; i2 < self.length; i2++) {
        ...
        if (cxtHasDiffed || newHasCxt && cxtHasMappedProps) {
          ...
          for (var j = 0; j < props.length; j++) {
            ...
            for (var k = i2 + 1; k < self.length; k++) {
              var laterCxt = self[k];
    ...
    styfn$8.updateStyleHints = function(ele) {
      ...
      var propHash = function propHash2(ele2, propNames2, seedKey) {
        return self.getPropertiesHash(ele2, propNames2, seedKey);
      };
    ...
    styfn$7.applyBypass = function(eles, name, value, updateTransitions) {
      ...
      if (name === "*" || name === "**") {
        if (value !== void 0) {
          for (var i2 = 0; i2 < self.properties.length; i2++) {
            var prop = self.properties[i2];
            var _name = prop.name;
    ...
    styfn$1.parseImpl = function(name, value, propIsBypass, propIsFlat) {
      ...
      if (type.multiple && propIsFlat !== "multiple") {
        ...
        for (var i2 = 0; i2 < vals.length; i2++) {
          var p2 = self.parse(name, vals[i2], propIsBypass, "multiple");
    ...
    ETCp.setupDequeueing = defs.setupDequeueing({
      ...
      onDeqd: function onDeqd(self, deqd) {
        for (var i2 = 0; i2 < self.onDequeues.length; i2++) {
          var fn2 = self.onDequeues[i2];
          fn2(deqd);
        }
      },
    ...
    LTCp.getLayers = function(eles, pxRatio, lvl) {
      ...
      var makeLayer = function makeLayer2(opts) {
        ...
        var layer2 = self.makeLayer(bb, lvl);
        if (after != null) {
      ...
      self.updateElementsInLayers(eles, function refineEachEle(layer, ele, req) {
        ...
        if (!rLyr.reqs) {
          for (var i2 = 0; i2 < rLyr.eles.length; i2++) {
            self.queueLayer(rLyr, rLyr.eles[i2]);
          }
        }
      });
    };
