...
var require_cytoscape_node_html_label = __commonJS({
  "node_modules/cytoscape-node-html-label/dist/cytoscape-node-html-label.js"(exports, module) {
    (function() {
      "use strict";
      ...
      var LabelElement = function() {
        function LabelElement2(_a, params) {
        ...
        LabelElement2.prototype.updateParams = function(_a) {
          var _b = _a.tpl, tpl = _b === void 0 ? function() {
            return "";
          } : _b, _c = _a.cssClass, cssClass = _c === void 0 ? null : _c, _d = _a.halign, halign = _d === void 0 ? "center" : _d, _e = _a.valign, valign = _e === void 0 ? "center" : _e, _f = _a.halignBox, halignBox = _f === void 0 ? "center" : _f, _g = _a.valignBox, valignBox = _g === void 0 ? "center" : _g;
          var _align = {
            "top": -0.5,
            "left": -0.5,
            "center": 0,
        ...
        LabelElement2.prototype.updateData = function(data) {
        ...
        LabelElement2.prototype.getNode = function() {
          return this._node;
        };
        LabelElement2.prototype.updatePosition = function(pos) {
          this._renderPosition(pos);
        };
        LabelElement2.prototype.initStyles = function(cssClass) {
        ...
        LabelElement2.prototype._renderPosition = function(position) {
      ...
      var LabelContainer = function() {
        function LabelContainer2(node) {
          this._node = node;
          this._elements = {};
        }
        LabelContainer2.prototype.addOrUpdateElem = function(id, param, payload) {
          if (payload === void 0) {
            payload = {};
          }
        ...
        LabelContainer2.prototype.removeElemById = function(id) {
          if (this._elements[id]) {
            this._node.removeChild(this._elements[id].getNode());
            delete this._elements[id];
          }
        };
        LabelContainer2.prototype.updateElemPosition = function(id, position) {
          var ele = this._elements[id];
          if (ele) {
            ele.updatePosition(position);
          }
        };
        LabelContainer2.prototype.updatePanZoom = function(_a) {
...
export default require_cytoscape_node_html_label();
